...
namespace lap
{
  ...
  shared_ptr<Mesh<VertexP> > meshPFromObj(const obj::ModelPtr& obj)
  {
    return meshFromObj<VertexP, uint1>(obj, makeVertexP);
  }

  shared_ptr<Mesh<VertexPT> > meshPTFromObj(const obj::ModelPtr& obj)
  {
    return meshFromObj<VertexPT, uint2>(obj, makeVertexPT);
  }

  shared_ptr<Mesh<VertexPN> > meshPNFromObj(const obj::ModelPtr& obj)
  {
    return meshFromObj<VertexPN, uint2>(obj, makeVertexPN);
  }

  shared_ptr<Mesh<VertexPTN> > meshPTNFromObj(const obj::ModelPtr& obj)
  {
  ...
  shared_ptr<Mesh<VertexPT> > indexedMeshPTFromObj(const obj::ModelPtr& obj)
  {
    return indexedMeshFromObj<VertexPT, uint2>(obj, keyPT, makeVertexPT);
  }
  shared_ptr<Mesh<VertexPN> > indexedMeshPNFromObj(const obj::ModelPtr& obj)
  {
    return indexedMeshFromObj<VertexPN, uint2>(obj, keyPN, makeVertexPN);
  }
  shared_ptr<Mesh<VertexPTN> > indexedMeshPTNFromObj(const obj::ModelPtr& obj)
  {
    return indexedMeshFromObj<VertexPTN, uint3>(obj, keyPTN, makeVertexPTN);
  }
  shared_ptr<Mesh<VertexP> > indexedMeshPFromObj(const obj::ModelPtr& obj)
  {
